...
st.markdown(
    """
<style>
/* CropGuard — complete premium glass redesign. Visual CSS only. */
...
.stButton>button,.stDownloadButton>button{width:auto!important;min-height:50px!important;padding:0 25px!important;border-radius:999px!important;border:1px solid rgba(255,255,255,.95)!important;background:linear-gradient(145deg,rgba(255,255,255,.96),rgba(232,245,235,.86))!important;color:#163a24!important;font-weight:800!important;box-shadow:0 12px 32px rgba(18,75,40,.14),inset 0 1px 0 #fff!important;transition:transform .2s ease,box-shadow .2s ease!important}
.stButton>button:hover,.stDownloadButton>button:hover{transform:translateY(-2px) scale(1.03)!important;box-shadow:0 18px 42px rgba(18,75,40,.2),inset 0 1px 0 #fff!important}.stButton>button:active,.stDownloadButton>button:active{transform:scale(.97)!important}
.stButton>button[kind="primary"]{background:linear-gradient(135deg,#2b8d52,#126337)!important;color:#fff!important;box-shadow:0 14px 38px rgba(20,105,55,.3),inset 0 1px 0 rgba(255,255,255,.35)!important}
...
@media(max-width:700px){
 .stApp{background-attachment:scroll!important;background-position:center top!important}
 .main .block-container{width:calc(100% - 18px)!important;padding:16px 0 45px!important}
 h1{font-size:2.65rem!important}h2{font-size:1.9rem!important}h3{font-size:1.28rem!important}
 .main .block-container p,.main .block-container li{font-size:1.01rem!important;line-height:1.52!important}
